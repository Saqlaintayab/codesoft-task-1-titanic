...
The dataset for this project is imported from a CSV file, "tested 2.csv". The dataset contains information about passengers on the Titanic, including their survival status, class (Pclass), sex (Gender), and age (Age).
